...
## Projects:
- **Health Companion with Symptom Checker and Chatbot**: Developed a robust symptom checker using a random forest model and a chatbot powered by a finely-tuned language model (LoRa).
- **Chess Vision Connect**: Real-time chess analysis using computer vision and deep learning. Integrated YOLOv8 for piece detection and Stockfish for move evaluation.
- **Data Analysis Project**: Led a stimulating TIPE project on machine learning, achieving 95% accuracy with a Multi-Layer Perceptron. Analyzed historical data to identify trends and insights.
- **Handwritten Digit Recognition with Deep Learning**: Implemented a deep learning model to recognize handwritten digits.

## Skills:
- **Programming Languages**: Python, C/C++, SQL, R
- **Technologies**: Predictive Modeling, NLP, Computer Vision, LLMs
- **Soft Skills**: Teamwork, Innovation, Analytical Skills, Ability to research and test new tools
...
[![Reddit](https://img.shields.io/badge/Reddit-%23FF4500.svg?logo=Reddit&logoColor=white)](https://reddit.com/user/B4MB1NA)
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/norah.trz)
[![Pinterest](https://img.shields.io/badge/Pinterest-%23E60023.svg?logo=Pinterest&logoColor=white)](https://pinterest.com/https://www.pinterest.com/norahtrz/)
